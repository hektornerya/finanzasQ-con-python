...
tickers = ['AMDA','BA','BABA','BAC','C','LVS','MAR','MELI','MU','NVDA',\
           'PBR','SLB','SU']  #CAPMfinancialmodelingSB
...
#import yfinance as yf
#datos = yf.download('AAPL', start='2023-01-01', end='2024-01-01')
#print(datos.head())
#datos.to_csv('AA.csv')
