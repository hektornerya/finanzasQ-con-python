...
#        'XLK','XLF','XLV','XLP','XLY','XLE','XLI'] 
#rics = ['LMT','IBM','TXN','ADP','AMT','PEP','KO','PM','VZ',\
 #           'TGT','HD','NEE','JNJ','XOM','SPGI'] #best stock for dividends 

# SYNCHRONISE all the time series of returns
df = market_data2.synchronise_returns(rics)
...
#correl = capm2.compute_correlation('^SPX','BTC-USD')
...
# synchronize all the time series of returns
#df = pd.DataFrame()
#dic_timeseries = {}
#timestamps = []
# get intersection of all timestamps
#for ric in rics:
#    t = market_data2.load_timeseries(ric)
