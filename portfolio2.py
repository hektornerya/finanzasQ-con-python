# -*- coding: utf-8 -*-
"""
Created on Thu Oct 26 12:32:06 2023
...
class manager:
    ...
    def compute_covariance(self):
        decimals = 6
        factor = 252
        df = market_data2.synchronise_returns(self.rics)
    ...
    def compute_portfolio(self, portfolio_type=None, target_return=None):
        ...
        markowitz = [{"type": "eq", "fun": lambda x: self.returns.dot(x) - target_return}] # target return
        
        # boundary conditions
        non_negative = [(0, None) for i in range(len(self.rics))]
        
        # compute portfolio via optimizer
...
def compute_efficient_frontier(rics, notional, target_return, include_min_variance):
    ...
    label3 = 'equi-weight'
    label4 = 'long-only'
    label5 = 'markowitz_none'
    label6 = 'markowitz_target'
