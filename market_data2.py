# -*- coding: utf-8 -*-
"""
Created on Tue Jun 18 17:03:17 2024
...
def load_timeseries(ric):
    ...
    t['date'] = pd.to_datetime(raw_data['Date']) #IA correeccion CHATGPT
...
#--------------------------------------------------------#
##raw_data = pd.read_csv('C:\\Users\\LENOVO\\.spyder-py3\\2024-1\\data2\\^SPX.csv')
# Convertir la columna 'Date' a formato datetime sin especificar dayfirst
##t = pd.DataFrame()
