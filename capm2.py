...
class model:
    ...
    def synchronise_timeseries(self):
        self.timeseries = market_data2.synchronise_timeseries(self.benchmark, self.security)
...
class hedger:
    ...
    def compute_hedge_weights(self, regularisation = 0):
        # initial coondition
        x0 = - self.position_delta_usd / len(self.hedge_betas) * np.ones(len(self.hedge_betas)) #CHATGPTI
